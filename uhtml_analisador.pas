...
function Tfb_Tokenizador_Html.getHtml_Conteudo: Unicodestring;
begin
  Result := strHtml_Conteudo;
end;

procedure Tfb_Tokenizador_Html.setHtml_Conteudo(aValue: Unicodestring);
begin
  self.strHtml_Conteudo := aValue;
end;

constructor Tfb_Tokenizador_Html.Create;
begin
  self.strTokens := TStringList.Create;
end;

destructor Tfb_Tokenizador_Html.Destroy;
begin
  FreeAndNil(self.strTokens);
end;

function Tfb_Tokenizador_Html.getHtml_Tokens: TStrings;
begin
...
procedure Tfb_Tokenizador_Html.setHtmlTokens(AValue: TStrings);
begin
...
function Tfb_Tokenizador_Html.Analisar_Html: boolean;
var
...
function Tfb_Tokenizador_Html.Analisar_Html(out strToken: TStrings): boolean;
begin
...
function Tfb_Tokenizador_Html.Analisar_Html(conteudo_em_html: string;
